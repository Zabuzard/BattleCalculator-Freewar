...
function initNpcData() {
    ...
    npcData['Agile Möwe'] = [6, 236];
    npcData['Algenechse'] = [6, 60];
    npcData['Allesfressender Koloa-Käfer'] = [1, 10];
    npcData['Alte Grottenschlange'] = [2710, 420000];
    npcData['Alte Pilzwachtel'] = [1, 3];
    npcData['Alte Quellwurzel'] = [1230, 100000];
    ...
    npcData['Dickbäuchiger Dachs'] = [3, 22];
    ...
    npcData['Eisbeißer'] = [8, 60];
    npcData['Eisbohrmaschine'] = [7, 90];
    npcData['Eisbohrmaschine-Prototyp'] = [7, 90];
    npcData['Eisfell-Yeti'] = [35, 3500];
    npcData['Eisforelle'] = [84, 850];
    npcData['Eishecht'] = [1055, 1010000];
    npcData['Eisjäger'] = [23, 180];
    npcData['Eiskaktus'] = [307, 91827];
    npcData['Eisqualle'] = [7603, 288800230];
    npcData['Eisritter'] = [3333, 375];
    npcData['Eisschleimgrünling'] = [0, 0];
    npcData['Eisschneckenhaus'] = [1, 100];
    npcData['Eisscholle'] = [201, 18420];
    npcData['Eisschwinge'] = [100, 1000];
    npcData['Eisseeigel'] = [6, 52];
    npcData['Eisvogel'] = [8, 60];
    npcData['Eiswelt-Echse'] = [340, 10000];
    npcData['Eiswurm'] = [6, 40];
    npcData['Eiszauberin'] = [60, 4500];
    npcData['Ektofron'] = [50, 5000];
    npcData['Elefant'] = [6495, 643543239];
    ...
    npcData['Felsengolem'] = [48, 11000];
    npcData['Felsenhuhn'] = [1, 2];
    ...
    npcData['Felsenspäher'] = [2280, 29315763];
    npcData['Felsenwurm'] = [4, 20];
    npcData['Felswall'] = [1, 100000000];
    ...
    npcData['Feuertränen-Qualle'] = [31, 825];
    ...
    npcData['Fieser Falter'] = [9, 3];
    npcData['Fiesmuschel'] = [1088, 13628544];
    ...
    npcData['Flubberrobbe'] = [2, 9];
    npcData['Fluktuatives Zauberlabor'] = [0, 1000];
    npcData['Flussmakrele'] = [45, 404];
    npcData['Flüsterfisch'] = [3849, 80152668];
    npcData['Flüstergeist'] = [1, 30];
    npcData['Friedlicher Eisjäger'] = [23, 180];
    ...
    npcData['Gefährlicher Stein'] = [1, 1000000000];
    ...
    npcData['Genervter Zauberer'] = [2535, 10000];
    ...
    npcData['Giftgrüne Eidechse'] = [53, 573];
    ...
    npcData['Gigantischer Lavablob'] = [47, 3000000];
    ...
    npcData['Goldener Palastwächter'] = [55, 21];
    ...
    npcData['Hüter der Knochen'] = [24805, 1000000];
    npcData['Hüter der Quelle'] = [2144, 777555333];
    ...
    npcData['Junges Ektofron'] = [14, 1400];
    npcData['Juwelenfisch'] = [1634, 155443];
    ...
    npcData['Klippenspringer'] = [1620, 173804];
    ...
    npcData['Küstenkratzer'] = [68, 28500];
    ...
    npcData['Lava-Qualle'] = [509, 261000];
    ...
    npcData['Nebelprinzessin'] = [22222, 1111111];
    npcData['Nebelscherbe'] = [0, 0];
    ...
    npcData['Neugieriger Flamingo'] = [4, 23];
    npcData['Nomade'] = [5, 50];
    npcData['Norpi'] = [5, 60];
    npcData['Nuschel'] = [1, 2];
    npcData['Oasenibis'] = [8000, 8000000];
    npcData['Obstbienen-Sammlerin'] = [2, 9];
    npcData['Obstbienen-Schwärmer'] = [382, 70000];
    ...
    npcData['Pfeilfisch'] = [98, 48020];
    npcData['Pfeilschnecke'] = [15, 150];
    npcData['Pfiffiger Pfau'] = [3, 22];
    ...
    npcData['Rosa Undaron'] = [1, 1];
    npcData['Rotbandwurm'] = [50, 2000];
    npcData['Rotbein'] = [5, 36];
    ...
    npcData['Salzwasserdorsch'] = [2147, 2022334];
    npcData['Salzwasserflussmakrele'] = [45, 404];
    npcData['Salzwassergrefekfisch'] = [3, 15];
    npcData['Salzwasserhantan'] = [267, 22330];
    npcData['Salzwasserjuwelenfisch'] = [1634, 155443];
    npcData['Salzwasserpantherfisch'] = [83, 808];
    npcData['Salzwasserqualle'] = [8, 6];
    npcData['Salzwassertintenfisch'] = [8, 6];
    npcData['Salzwasservogel'] = [3, 20];
    npcData['Sandalin'] = [6, 40];
    npcData['Sandbär'] = [3, 16];
    npcData['Sandechse'] = [2, 7];
    npcData['Sandfresserwurm'] = [6, 70];
    npcData['Sandgeist'] = [4, 20];
    npcData['Sandgolem'] = [1, 26];
    npcData['Sandhorn'] = [23, 600];
    npcData['Sandiger Wirbelwind'] = [800, 7000];
    npcData['Sandvogel'] = [8, 80];
    npcData['Saugfisch'] = [2, 16];
    npcData['Sausender Seeschnapper'] = [3, 22];
    ...
    npcData['Schneller Stein'] = [7439, 213425];
    ...
    npcData['Schusselige Schneeeule'] = [3, 22];
    ...
    npcData['Schwammkrebs'] = [1830, 23152790];
    ...
    npcData['Silberschuppen-Alligator'] = [4532, 163259];
    ...
    npcData['Somniumor'] = [1322, 135547];
    npcData['Sonnenanbeter'] = [55, 5000];
    npcData['Spaltlauscher'] = [12872, 854920153];
    ...
    npcData['Steinrochen'] = [425, 134000];
    ...
    npcData['Sumpfgreifer'] = [14, 114];
    npcData['Sumpflandkröte'] = [2, 15];
    npcData['Sumpfschrecke'] = [12, 170];
    npcData['Sumpfspinne'] = [3, 20];
    npcData['Südmeer-Tucan'] = [1, 2];
    npcData['Südmeerschwalbe'] = [45, 701];
    npcData['Süßer Tod'] = [8, 48];
    npcData['Süßwasserdorsch'] = [2147, 2022334];
    npcData['Süßwasserflussmakrele'] = [45, 404];
    npcData['Süßwassergrefekfisch'] = [3, 15];
    npcData['Süßwasserhantan'] = [267, 22330];
    npcData['Süßwasserjuwelenfisch'] = [1634, 155443];
    npcData['Süßwasserpantherfisch'] = [83, 808];
    npcData['Süßwasserqualle'] = [8, 6];
    npcData['Süßwassertintenfisch'] = [8, 6];
    npcData['Taburok der Gigantische'] = [238, 10000];
    npcData['Tapferer Tornadotaucher'] = [3, 22];
    npcData['Tapir'] = [12, 101];
    npcData['Taucher'] = [115, 6938];
    npcData['Taucherflussmakrele'] = [45, 404];
    npcData['Tauchergrefekfisch'] = [3, 15];
    npcData['Taucherpantherfisch'] = [83, 808];
    npcData['Teidam'] = [5, 50];
    ...
    npcData['Unheimliches Steintor'] = [9800, 575842948];
    ...
    npcData['Verirrter Lastkäfer'] = [126, 12405];
    ...
    npcData['Versteinerter Wächter'] = [1000000000, 2000000000];
    ...
    npcData['Wachsamer Wüstenfalke'] = [3, 22];
    ...
    npcData['Wurzelfisch'] = [34, 958];
    npcData['Wurzelgeist'] = [7, 28];
    ...
    npcData['Zebraschlange'] = [5367, 141224271];
